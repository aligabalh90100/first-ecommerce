  ...
  return (
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        <p>
          An e-commerce website in an online platform that facilitate buying and
          seling of products or services over the internet serves as a virtual
          marketplace where businesses and individuals can showcase their
